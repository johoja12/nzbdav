...
public class NzbFile
{
    ...
    /// <summary>
    /// Gets the filename parsed from the subject line.
    /// This is a convenience property that calls GetSubjectFileName().
    /// </summary>
    public string FileName => GetSubjectFileName();

    /// <summary>
    /// Gets the total yEncoded size of all segments.
    /// Alias for GetTotalYencodedSize() for backwards compatibility.
    /// </summary>
    public long Size => GetTotalYencodedSize();
